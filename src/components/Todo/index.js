                ...
                <ScrollView style={styles.container}>
                    <ScrollView style={styles.note}>
                        ...
                        <View>
                            <TextInput
                                style={styles.input}
                                placeholder='Me dá um título, pleaase'
                                multiline={true}
                        ...
                        <View style={styles.buttonContainer}>
                            <TouchableOpacity 
                                onPress={() => (this.prs.title) ? 
                                    (this.props.editTodo(this.prs._id, this.state.title, this.state.description)) :
                                    (this.props.newTodo(this.state.title, this.state.description))}
                            >
                                <View style={styles.buttonContainer}>
...
Todo.navigationOptions = ({ navigation }) => ({
...
const mapDispatchToProps = dispatch => ({
    editTodo: (_id, title, description) => dispatch(allActions.editTodo(_id, title, description)),
    newTodo: (title, description) => dispatch(allActions.newTodo(title, description)),
});
